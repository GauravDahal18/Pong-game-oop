...
//     Rectangle multiplayerButton = { screen_width / 2 - 150, screen_height / 2 - 60, 300, 50 };
//     Rectangle aiButton = { screen_width / 2 - 150, screen_height / 2 + 10, 300, 50 };
...
//         DrawRectangleRec(aiButton, Light_Green);

//         DrawText("Multiplayer", multiplayerButton.x + 75, multiplayerButton.y + 15, 20, WHITE);
//         DrawText("Play Against AI", aiButton.x + 65, aiButton.y + 15, 20, WHITE);
...
//             return true;
//         }
//         if (CheckCollisionPointRec(GetMousePosition(), aiButton) && IsMouseButtonReleased(MOUSE_LEFT_BUTTON)) {
//             return false;
//         }
//     }

//     return false;  // Default to AI mode if window is closed
// }
...
//                 game_over = true;
//                 winner = is_multiplayer ? "Player 2" : "AI";
//             }
//         }
//         else {
...
//             DrawText(TextFormat("%s Wins!", winner.c_str()), screen_width / 2 - MeasureText(TextFormat("%s Wins!", winner.c_str()), 60) / 2, screen_height / 2 - 30, 60, WHITE);
...
bool Game::ShowMenuScreen() {
    ...
    while (!WindowShouldClose()) {
        ...
        DrawText("Play Against AI", static_cast<int>(aiButton.x + 65), static_cast<int>(aiButton.y + 15), 20, WHITE);
